    ...
    <div>
          ...
          <a-row type="flex" align="middle">
            <a-col :span="24" :md="12" class="col-info">
              ...
              <div class="avatar-info">
                <h4 class="font-semibold m-0">{{employee.first_name}}<span class="mx-4"></span>{{employee.last_name}}</h4>
                <p>{{employee.email}}</p>
      ...
      <a-row type="flex" :gutter="24">
        <a-col :span="24" :md="16" class="mb-24">
           <edit-employee-form :client="currentClient" :employee="employee"></edit-employee-form>
        </a-col>
